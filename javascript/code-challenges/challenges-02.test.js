...
const raisedToTheThird = (arr) => {
  ...
  arr.forEach(function(nums){
    powerThree.push(Math.pow(nums, 3))
  })
...
const addOne = (arr) => {
  // Solution code here...
  let plusOne = arr.map(function(num){
    return num + 1;
  })
...
const addQuestion = (arr) => {
  // Solution code here...
  let question = arr.map(function(strings){
    return strings + '?'
  })
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let twoThePower = arr.map(function(nums){
    return Math.pow(2, nums)
  })
...
const charCode = (arr) => {
  // Solution code here...
  let stringToNum =arr.map(function(string){
